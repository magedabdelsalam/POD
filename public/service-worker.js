...
self.addEventListener("fetch", function(evt) {
  ...
  if (url.includes("/api/pods") || url.includes("/api/kids") || url.includes("/logout") || url.includes("/sessiondata") || url.includes("/login") || url.includes("/signup") || url.includes("/home") || url.includes("/")) {
    evt.respondWith(
